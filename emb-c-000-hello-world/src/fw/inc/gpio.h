...
/* GPIO Mode register: */
#define GPIO_MODER_REG_OFFSET          ((uint32_t) 0x0)
#define GPIO_MODER_REG                 (*(__IO uint32_t*)(GPIOG_BASE_ADDRESS + GPIO_MODER_REG_OFFSET))
/* GPIO Output data register: */
#define GPIO_ODR_REG_OFFSET            ((uint32_t) 0x14)
#define GPIO_ODR_REG                   (*(__IO uint32_t*)(GPIOG_BASE_ADDRESS + GPIO_ODR_REG_OFFSET))
